const def = `const members = [
  {
    ...
    profile: [
      { social: 'facebook', url: 'https://www.facebook.com/JavaScriptTeam/' },
      { social: 'twitter', url: 'https://twitter.com/front10hello?lang=es' }
    ]
  },
  {
    ...
    profile: [
      { social: 'facebook', url: 'https://www.facebook.com/JavaScriptTeam/' },
      { social: 'email', url: 'https://front10.com' }
    ]
  },
  {
...
<Team showBorder={false} />`;

const tb = `const members = [
  {
    image: 'images/team/ninja.svg',
    name: 'Leonardo',
    job: 'Ninja',
...
<Team imageBorder topColor="#E47070" />`;

const shadow = `const members = [
  {
    image: 'images/team/ninja.svg',
    name: 'Leonardo',
    job: 'Ninja',
