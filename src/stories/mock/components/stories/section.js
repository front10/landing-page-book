  ...
  stories: [
    ...
    <Container className="text-left">
        <p style={{color: '#3d3d3d'}}>
            Once upon a time, there was a boy named James. He always got 
            pushed around. One day, a wizard appeared in front of the boy.
            The wizard gave James three wishes. One of James wishes was 
            that tge wizard could make James go away. The next day James 
            tried to make a wish, but he found himself to be in the land
            of the forgotten.
        </p>
    </Container>
</Section>`,
    ...
    },
    {
      name: 'With Video',
      summary: '',
      code: `<Section title="WHAT WE DO" subTitle="One Look Is Worth A Thousand Words.">
