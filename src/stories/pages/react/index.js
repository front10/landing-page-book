          ...
          <Row>
            <Column className="col-12 col-md-4">
              ...
              <p className="ReactPage__FeaturesSummary pt-3">
                ...
                returns what to display. This example uses an XML-like syntax called JSX. Input data
                that is passed into the component can be accessed by <code>render()</code> via{' '}
          ...
          <Row>
            <Column className="col-12 col-md-4">
              ...
              <p className="ReactPage__FeaturesSummary pt-3">
                ...
                application. This example uses <code>state</code> to track the current list of items
                as well as the text that the user has entered. Although event handlers appear to be
          ...
          <Container>
            <Row>
              ...
              <Column className="col text-left">
                ...
                <Link className="d-block" href="http://stackoverflow.com/questions/tagged/reactjs">
                  Stack Overflow
                  <Icon icon="fa fa-share-square-o" className="ml-1" />
                </Link>
            ...
            <Row className="row mt-5">
              ...
              <Column className="col text-left">
                ...
                <Link className="d-block" href="https://reactjs.org/community/debugging-tools.html">
                  Tools
                </Link>
              </Column>
              <Column className="col text-left">
